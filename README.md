...
Another goal is to implement a model of the spatial world into Four Mountains. This would allow computer-controlled characters to move in a natural-looking computer-generated environment and spontaneously express emotions, form friendships, find enemies, specialize in different roles, form a heterarchy, increase or reduce the social authority of each other, split into subgroups according to friendship instead of plan and so on. What kind of friends are sought after can be affected by external factors. Such as, if a computer-controlled character wanted to have fun, they would seek the company of happy characters, and if they wanted to learn things they would seek the company of knowledgeable characters.
